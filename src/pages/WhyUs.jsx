      ...
      <section className={styles.bg2}>
          ...
          <div className={styles.whysBox}>
            <div className={`${styles.whys} ${styles.whys1}`}>
              ...
              <p>
                ...
                برای «برنامه بزرگ بعدی» ارسال کرد و یک فرآیند رأی‌گیری عمومی
                تعیین کرد که کدام برنامه‌ها زنده می‌شوند
              </p>
            </div>
            <div className={`${styles.whys} ${styles.whys2}`}>
              ...
              <p>
                سه سال، بیش از 2000 ایده و 16 برنامه راه‌اندازی شده بعد، ما به
                طور مستقیم به استراتژی‌ها و مبارزات طراحی و توسعه برنامه‌های
                موبایلی با کیفیت پی بردیم. ما کمبود شدید آژانس‌هایی را پیدا
                کردیم که نیازهای استارت‌آپ‌ها را درک کنند و کسب‌وکارهایی را
                تأسیس کنند که از دلیل ایجاد نرم‌افزار آگاه باشند و فرآیندی داشته
                باشند که موفقیت محصول را با کاربرانش تضمین کند
              </p>
            </div>
            <div className={`${styles.whys} ${styles.whys3}`}>
              ...
              <p>
                برای ما مشخص شد که در مرحله بعد چه کار کنیم: تصمیم گرفتیم
                Applits را ببندیم تا بتوانیم آژانس خود را برای حل این مشکلات
                دقیق ایجاد کنیم. با پیروی از فلسفه کلاسیک «ضرورت مادر اختراع
                است»، ما چیزی را ساختیم که آرزو می‌کردیم سال‌ها پیش به‌عنوان
                مشتریان پرداخت‌کننده پیدا می‌کردیم. ما فرآیند خود را برای
                شناسایی اقدامات و مراحل کلیدی برای موفقیت در هنگام ساختن
                نرم‌افزار موبایل اول برای مصرف‌کنندگان خواستار بررسی کرده‌ایم
              </p>
            </div>
            <div className={`${styles.whys} ${styles.whys4}`}>
              <div className="d-flex align-items-center justify-content-start">
                <div className={`w-75 ${styles.line}`}></div>
                <h5 className={`w-100 ${styles.h5}`}>
                  در دسترس قرار دادن نرم افزار
                </h5>
              </div>
              <p>
                ما یک تیم با استعداد داریم که خود را وقف موفقیت پروژه شما می
                کنند و شما را از طریق اکوسیستم پیچیده ایجاد نرم افزار سفارشی
                راهنمایی می کنند. ما بارها و بارها ثابت کرده‌ایم که توسعه برنامه
                نیازی به پیچیده نیست. با Designli، می توانید انتظار داشته باشید
                که روند ساخت یک محصول دیجیتال هرگز یک رمز و راز نباشد
              </p>
            </div>
          </div>
        ...
        <section className={styles.section3}>
          <div className={styles.cardSection3}>
            <p>
              با ما آشنا شوید: ما مشتاقانه منتظر بررسی مشکل شما و همکاری در راه
              حل هستیم
            </p>
          </div>
        </section>
          ...
          <div className={styles.teamPart}>
            ...
            >
              ...
              <p className={styles.aboutPerson}>
                ...
                آن زمان تاکنون پروژه‌های برنامه‌ها و برنامه‌های وب را با
                Designli رهبری می‌کند
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className={styles.aboutPerson}>
                ...
                دارد، مخالف جمعیت است. جاش که یک ورزشکار کالج و دانشجوی مهندسی
                بود کالج را رها کرد، می خواست به جای گرفتن مدرک، کارآفرینی را
                دنبال کند. این زمانی بود که او با کیث همکاری کرد و اشتیاق خود را
                به پیچیدگی های فنی ساخت و راه اندازی سیستم های نرم افزاری جدید
                پیدا کرد. جاش به‌عنوان یک خلبان خصوصی، غواص و علاقه‌مند به امور
                مالی شخصی مشتاق، «جک سرگرمی‌های متعدد» و استاد، خوب، برخی است.
                جاش به‌عنوان مدیر اجرایی Designli، از یادگیری نحوه عملکرد
                کسب‌وکار مشتریان و کشف نحوه طراحی و پیاده‌سازی نرم‌افزار برای حل
                مشکلات آنها لذت می‌برد
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className={styles.aboutPerson}>
                ...
                کلیپ با عکس یا هر چیز دیگه داشتم. وقتی یه کامپیوتر درب داغون
                قدیمی خریدیم انگار دنیا مال من بود خیلی کوچیک بودم ولی با نرم
                افزارهایی مثل pint و powerpoint سعی میکردم اثر هنری خلق کنم در
                نهایت وقتی رسیدم به هنرستان سریعا رشته مورد علاقمو پیدا کردم
                &quot;گرافیک&quot;! از سال 1397 تا به الان دست از گرافیک نکشیدم
                و هروز علاقم بیشتر شده و حالا به جایی رسیدم که در هر زمینه ای از
