...
function Home() {
  return (
    <main id="fullpage">
      <section className="section active container-fluid content-header bg-main-page">
                ...
                <div className="row">
                  <div className="col-12 col-md-6 div-about-team">
                    ...
                    <p className="about-us-section-p">
                      ...
                      استایین یک متن نمون استایین یک متن نمون استایین یک متن
                      نمون استایین یک متن نمون استایین یک متن نمون استایین یک
                      متن نمون استایین یک متن نمون است
                    </p>
                  </div>
                </div>
              </div>
